...
def ec2_networkacl_allow_ingress_tcp_port_22_1(ec2_client):
    ...
    try:
        ...
        for network_acl in network_acls:
            ...
            report = {
                ...
                "status_extended": f"Network ACL {network_acl['NetworkAclId']} does not have SSH port 22 open to the Internet."  # 상태 확장 설명
            }

            # 네트워크 ACL의 Entry들을 확인하여 SSH 포트 22가 인터넷에 열려 있는지 검사
            if check_network_acl(network_acl['Entries'], tcp_protocol, check_port):
                report["status"] = "FAIL"
                report["status_extended"] = f"Network ACL {network_acl['NetworkAclId']} has SSH port 22 open to the Internet."
...
if __name__ == "__main__":
    ...
    result = ec2_networkacl_allow_ingress_tcp_port_22_1(ec2_client)  # 함수 호출하여 결과 저장
